...
SOURCE_DIR="/home/uprhan/hanglibc/glibc"
BUILD_DIR="/home/uprhan/hanglibc/build/"
CMD_FILE="/home/uprhan/hanglibc/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
run --library-path /home/uprhan/hanglibc/build:/home/uprhan/hanglibc/build/math:/home/uprhan/hanglibc/build/elf:/home/uprhan/hanglibc/build/dlfcn:/home/uprhan/hanglibc/build/nss:/home/uprhan/hanglibc/build/nis:/home/uprhan/hanglibc/build/rt:/home/uprhan/hanglibc/build/resolv:/home/uprhan/hanglibc/build/mathvec:/home/uprhan/hanglibc/build/support:/home/uprhan/hanglibc/build/crypt:/home/uprhan/hanglibc/build/nptl:${BUILD_DIR}/nptl_db __COMMANDLINE__ __DIRECT__
__BREAKPOINTS__
EOF
}
...
WAIT_FOR_DEBUGGER=1 /home/uprhan/hanglibc/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
