...
static tunable_t tunable_list[] attribute_relro = {
  ...
  {TUNABLE_NAME_S(glibc, pthread, rseq), {TUNABLE_TYPE_INT_32, 0, 1}, {.numval = 1}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, {0}},
  ...
  {TUNABLE_NAME_S(glibc, malloc, hugetlb), {TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, {0}},
  ...
  {TUNABLE_NAME_S(glibc, rtld, dynamic_sort), {TUNABLE_TYPE_INT_32, 1, 2}, {.numval = 2}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, {0}},
